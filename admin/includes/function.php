...
if($move_1 && $move_2 && $move_3){
    ...
    $insert = mysqli_query($con,"INSERT INTO `merchandise`(`p_cat_id`,`name`, `description`, `mrp`, `price`, `image_1`,`image_2`,`image_3`, `sale_status`,`p_status`) VALUES ('$p_cat','$name','$des','$mrp','$price','$name_1','$name_2','$name_3','$sale_status','$p_status')");
if($insert){
