...
<div class="container-fluid" style="background-color:black; color:white; border-radius:20px; padding:5%;">
<h1 class="text-center text-white">Products</h1><a href="index.php?add_merch" class="btn btn-success" style="float:right;">Add Products  <i class="fa-solid fa-plus"></i></a>
<table class="table text-center" bordered style="background:white;">
  <thead>
    <tr>
      <th scope="col">#</th>
...
<tr>
    ...
    <td><?php echo $row_p['description']; ?></td>
...
<?php 
       ...
       echo  '<tr><center><td><p class="text-center text-white/">No Record Found</p></td></center></tr>';
    }
