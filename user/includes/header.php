...
<script defer data-site="YOUR_DOMAIN_HERE" src="https://api.nepcha.com/js/nepcha-analytics.js"></script>
  ...
  <center>  <i class="fa-solid fa-3x text-center mt-5  fa-user text-white"></i>
      <p class="ms-1 font-weight-bold text-white text-center text-uppercase"><?php echo $row_user['fullname'] ;?></p>
...
<li class="nav-item">
  <a class="nav-link text-white " href="index.php?settings">
...
<li class="nav-item">
  <a class="nav-link text-white " href="index.php?orders">
...
<li class="nav-item">
  <a class="nav-link text-white " href="index.php?match&type=view_teams">
...
<li class="nav-item">
  <a class="nav-link text-white " href="index.php?match&type=view_match">
    ...
    <span class="nav-link-text ms-1">Upcoming Matches</span>
  </a>
</li>
